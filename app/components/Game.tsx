...
const Game = () => {
    ...
    .onEnd(() => setDirection(Direction.Left));

    const right = Gesture.Fling()
    .direction(Directions.RIGHT)
    .onEnd(() => setDirection(Direction.Right));

    const up = Gesture.Fling()
    .direction(Directions.UP)
    .onEnd(() => setDirection(Direction.Up));

    const down = Gesture.Fling()
    .direction(Directions.DOWN)
    .onEnd(() => setDirection(Direction.Down));

  // Combine gestures
  const gestures = Gesture.Exclusive(left, right, up, down);
